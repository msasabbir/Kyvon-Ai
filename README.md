<p align="center">
  <img src="logo.png" alt="Kyvon_Ai" width="600">
</p>

# Kyvon Ai

**Run AI coding agents (Kyvon Ai, Claude Code, Gemini CLI) in just $4 entirely from your phone.**
...
```
curl -sL https://raw.githubusercontent.com/msasabbir/kyvon-ai/main/setup.sh | bash
```
